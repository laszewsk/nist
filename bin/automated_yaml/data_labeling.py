...
description="Oracle Cloud Infrastructure (OCI) Data Labeling is a service for building labeled datasets to more accurately train AI and machine learning models. With OCI Data Labeling, developers and data scientists assemble data, create and browse datasets, and apply labels to data records through user interfaces and public APIs. The labeled datasets can be exported for model development across Oracle's AI and data science services for a seamless model-building experience.",public="true", documentation="https://www.oracle.com/in/artificial-intelligence/speech/", tags=["AI", "Iamge Classification", "Virtual Assistance", "Irregularity Detection", "Forms Processing", "Information Extraction"], categories=["AI", "Virtual Assistance"], filename="D:\\Code\\nist\\github\\nist\\oracle_ai_services\\oracle_labeling.yaml", ),f, sort_keys=False)
