...
class yaml_maker(yaml.YAMLObject):
    ...
    def __init__(self, name, title, author, description, filename, documentation, tags, categories, id="unknown",
                 slug="unknown", public="true", version="unknown", license="unknown",
                 microservices="no", protocol="TBD", source="unknown", endpoint="unknown", specification="unknown",
                 owner="Oracle", additional_metadata="unkown", sla="https://www.oracle.com/cloud/sla/",
